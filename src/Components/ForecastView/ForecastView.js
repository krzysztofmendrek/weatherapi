        ...
        <div id='weatherForecastView' className='weather-info__forecast-view'>
          ...
          <div className='weather-info--bottom'>
            <div>
              <h2>MAX</h2>
              <p>
                <span>{searchWeather.maxTemp === 'null' ? 'N/A' : searchWeather.maxTemp}°</span>
              </p>
            </div>
            <div>
              <h2>MIN</h2>
              <p>
                <span>{searchWeather.minTemp === 'null' ? 'N/A' : searchWeather.minTemp}°</span>
              </p>
            </div>
            <div>
              <h2>LLUVIA</h2>
              <p>
                <span>{searchWeather.pred === 'null' ? 'N/A' : searchWeather.pred}</span>%
              </p>
            </div>
            <div>
              <h2>VIENTO</h2>
              <p>
                <span>{searchWeather.windSpeed === 'null' ? 'N/A' : searchWeather.windSpeed}</span>
                km/h
              </p>
            </div>
          </div>
